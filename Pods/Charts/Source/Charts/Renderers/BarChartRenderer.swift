...
open class BarChartRenderer: BarLineScatterCandleBubbleRenderer
{
    ...
    {
        ChartUtils.drawText(context: context, text: value, point: CGPoint(x: xPos, y: yPos), align: align, attributes: [NSFontAttributeName as NSString: font, NSForegroundColorAttributeName as NSString: color])
    }
