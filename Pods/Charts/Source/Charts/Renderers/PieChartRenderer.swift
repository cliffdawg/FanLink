                ...
                if drawXOutside || drawYOutside
                {
                    ...
                    if drawXOutside && drawYOutside
                    {
                        ChartUtils.drawText(
                            ...
                            point: labelPoint,
                            align: align,
                            attributes: [NSFontAttributeName as NSString: valueFont, NSForegroundColorAttributeName as NSString: valueTextColor]
                        )
                        ...
                        if j < data.entryCount && pe?.label != nil
                        {
                            ChartUtils.drawText(
                                ...
                                align: align,
                                attributes: [
                                    NSFontAttributeName as NSString: entryLabelFont ?? valueFont,
                                    NSForegroundColorAttributeName as NSString: entryLabelColor ?? valueTextColor]
                            )
                        }
                    }
