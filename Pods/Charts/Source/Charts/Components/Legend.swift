...
open class Legend: ComponentBase
{
    ...
    @objc open func getMaximumEntrySize(withFont font: NSUIFont) -> CGSize
    {
        ...
        for entry in entries
        {
            ...
            let size = (label as NSString!).size(attributes: [(NSFontAttributeName as NSString) as String: font])
    ...
    @objc open func calculateDimensions(labelFont: NSUIFont, viewPortHandler: ViewPortHandler)
    {
        ...
        case .horizontal:
            ...
            let labelAttrs = [NSFontAttributeName as NSString: labelFont]
            ...
            for i in 0 ..< entryCount
            {
                ...
                if label != nil
                {
                    calculatedLabelSizes[i] = (label as NSString!).size(attributes: labelAttrs as [String : Any])
