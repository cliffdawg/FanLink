...
open class ChartViewBase: NSUIView, ChartDataProvider, AnimatorDelegate
{
    ...
    open override func draw(_ rect: CGRect)
    {
        ...
        if _data === nil && noDataText.characters.count > 0
        {
            ...
            ChartUtils.drawMultilineText(
                ...
                attributes:
                [NSFontAttributeName as NSString: noDataFont,
                 NSForegroundColorAttributeName as NSString: noDataTextColor],
    ...
    @objc internal func drawDescription(context: CGContext)
    {
        ...
        attrs[NSFontAttributeName as NSString] = description.font
        attrs[NSForegroundColorAttributeName as NSString] = description.textColor
